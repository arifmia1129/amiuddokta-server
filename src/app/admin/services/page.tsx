...
export default function ServiceList() {
  ...
  const handleBulkDelete = async () => {
    ...
    confirmAlert({
      ...
      message: `Are you sure you want to delete ${selectedIds.length} selected service(s)? This action cannot be undone.`,
      buttons: [
        {
          label: "Delete All",
          className: "bg-red-500 text-white px-4 py-2 rounded-md",
          onClick: async () => {
            ...
            try {
              ...
              toast.success(
                `${selectedIds.length} services deleted successfully`,
              );
              setSelectedIds([]);
            ...
            <div className="flex h-64 flex-col items-center justify-center p-4 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 max-w-md">
                {searchText || activeFilters.length > 0
                  ...
                  : "There are no services in the system yet. Click 'Add New Service' to create one."}
              </p>
            </div>
          ) : (
                        ...
                        <div className="ml-3 flex items-center">
                          <div className="h-10 w-10 flex-shrink-0">
                            <Image
                              src={
                                service?.icon
                                  ? `${constant.baseUrl}/api/files?fileName=${service?.icon}`
                                  : "/images/no_image.png"
                              }
