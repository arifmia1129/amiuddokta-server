...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | ProductiveShield - Next.js Dashboard Template",
  description:
    "This is Next.js SignUp Page ProductiveShield Dashboard Template",
  // other metadata
};
