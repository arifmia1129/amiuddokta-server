...
export const createUserSchema = z.object({
  ...
  pin: z
    ...
    .max(20, "PIN must not exceed 20 characters"),
  role: z
  ...
  center_name: z
    .string()
    .max(200, "Center name must not exceed 200 characters")
    .optional(),
  center_address: z
    .string()
    .max(500, "Center address must not exceed 500 characters")
    .optional(),
...
export const changePinSchema = z.object({
  ...
  newPin: z
    ...
    .max(20, "New PIN must not exceed 20 characters"),
});
