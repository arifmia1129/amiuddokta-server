...
export default function FeatureImageUploader({
  ...
  return (
    <div className="relative flex flex-col items-center justify-center">
      <div
        onClick={uploadImage}
        className="flex cursor-pointer items-center justify-center rounded-md border-2 border-stroke dark:border-form-strokedark"
        style={{ height: `${height}px`, width: `${width}px` }} // Apply styles dynamically
      >
        {imageUrl ? (
          <Image
          ...
          <small>{placeholder ? placeholder : "Set featured image"}</small>
        )}
      </div>
      {imageUrl && (
